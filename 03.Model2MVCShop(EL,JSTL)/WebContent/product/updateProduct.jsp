...
<%System.out.println("updateProduct.jsp까지 들어온 vo"+vo); %>
<html>
<head>
<title>상품정보수정</title>
...
<table width="100%" height="37" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<input type="hidden" name="REG_DATE"  value="<%=vo.getRegDate() %>" />
		...
		<td align="right">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td width="14" height="23">
						<img src="/images/ct_btnbg03.gif" width="14" height="23"/>
						<%System.out.println("updateProduct.jsp까지 쓰고 넘기는 vo"+vo); %>
					</td>
				</tr>
			</table>
		</td>
